...
export interface HeaderProps {
  ...
  repoUrl: string | null;
  // Task 56.5: same telegram_channel_url the sidebar/filter-sheet banner
  // uses (see lib/api/telegramConfig.ts) — one source of truth, so this
  // icon, the footer link, and the banner all appear or hide together.
      ...
      <div class="header-inner">
        ...
        {telegramChannelUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={dict.telegramLinkAria}
            title={dict.telegramLinkAria}
          >
            <TelegramIcon />
          </a>
        )}
